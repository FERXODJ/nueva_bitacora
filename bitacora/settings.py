...
SECRET_KEY = 'django-insecure-f*6^5dxpw=%za0p3pu*96(=5vvr^9ujkjs(w=6_4tr9wn3s#i2'
...
ALLOWED_HOSTS = ['.vercel.app', 'nueva-bitacora.vercel.app']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Añadir el directorio 'templates'
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
